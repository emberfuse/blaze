<template>
    <action-section>
        ...
        <template #content>
            ...
            <div class="mt-6 space-y-8" v-if="sessions.length > 0">
            ...
            <div class="flex items-center mt-6">
                <app-button mode="primary" @click.native="confirmLogout">
            ...
            <dialog-modal :hasActions="true" :show="confirmingLogout" @close="closeModal">
                <template #title>
                    Logout Other Browser Sessions
                </template>
                ...
                <template #content>
                    ...
                    <div class="mt-4">
                        <app-input type="password" v-model="form.password" :error="form.errors.password" ref="password" label="Password" placeholder="cattleFarmer1576@!" @keyup.enter.native="logoutOtherBrowserSessions"></app-input>
                    </div>
                </template>

                <template #actions>
                    <app-button mode="secondary" @click.native="closeModal">
                        Cancel
                    </app-button>

                    <app-button mode="primary" class="ml-3" @click.native="logoutOtherBrowserSessions" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                        Logout Other Browser Sessions
                    </app-button>
                </template>
            </dialog-modal>
